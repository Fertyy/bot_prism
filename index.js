...
Client.on("messageCreate", message => {
  ...
  if (message.content === prefix + "boutique"){
      const embed = new Discord.MessageEmbed()
          ...
          .addField("Vous avez demander la boutique ?", "Il vous suffit simplement de cliquer sur ce lien :link: https://teamfrench.eu/boutique/index.php et de faire votre choix !")
